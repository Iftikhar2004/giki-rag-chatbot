...
def fallback_answer(question, context):
    return (
        "Here are the most relevant excerpts from the prospectus:\n\n"
        + context
    )
...
st.divider()
st.caption(" Tip: Use smaller chunk size if answers miss details; increase overlap for better continuity.")
